...
class QuartzTriggerTable extends AbstractQuartzTable {
	...
	public String[] getTabularDataLabels() {
		...
		return new String[] {
				...
				I18NSupport.getLocalizedMessage(BUNDLE_NAME, cl, "label.trigger.volatile"),//$NON-NLS-1
	...
	public Object[][] getTabularData(Scheduler scheduler) throws SchedulerException {
		...
		for (String triggerGroupName : allTriggerGroupNames) {
			...
			for (String triggerName : triggerNames) {
				...
				if (trigger == null) {
					// trigger disappeared between list construction and exploitation
					continue;
				}
...
//				assert triggerGroupName.equals(trigger.getGroup());
				...
				data.add(new Object[] {
						...
						// trigger state
						I18NSupport.getLocalizedMessage(BUNDLE_NAME, cl, "trigger.state."+triggerState),//$NON-NLS-1$
